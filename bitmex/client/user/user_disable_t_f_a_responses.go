...
func (o *UserDisableTFAOK) Error() string {
	return fmt.Sprintf("[POST /user/disableTFA][%d] userDisableTFAOK  %+v", 200, o.Payload)
}

func (o *UserDisableTFAOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
