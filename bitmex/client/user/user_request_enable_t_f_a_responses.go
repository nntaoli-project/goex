...
func (o *UserRequestEnableTFAReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUserRequestEnableTFAOK()
...
func (o *UserRequestEnableTFAOK) Error() string {
	return fmt.Sprintf("[POST /user/requestEnableTFA][%d] userRequestEnableTFAOK  %+v", 200, o.Payload)
}

func (o *UserRequestEnableTFAOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
